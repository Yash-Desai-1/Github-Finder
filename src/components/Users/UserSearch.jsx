...
import { searchResult } from "../../context/github/GithunActions";
...
const UserSearch = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(text === ''){
            ...
            const users = await searchResult(text)
        ...
        <form onSubmit={handleSubmit}>
            <div className="form-control">
                <div className="relative">
                    <input type="text" className="font-semibold w-full pr-40 bg-gray-200 input input-lg text-black" placeholder="Search" value={text} onChange={handleChange} />
